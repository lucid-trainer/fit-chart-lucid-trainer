...
for (const [i, value] of act_file_data.entries()) {
  let fieldValue = value.accelmove;
...
const fileData = readFileSync(require.resolve("./template/accel-activity.tmp"), { encoding: "utf8" });
